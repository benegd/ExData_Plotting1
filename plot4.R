...
#plot 1 - Global Active Power v Date Time
...
#plot 3 - Sub metering v Date Time 
...
#plot 4 - Global Reactive Power v Date Time
...
outputfilepath <- paste(filedirpath, "/plot4.png", sep = "")
